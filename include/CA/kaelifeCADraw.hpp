/**
 * @file kaelifeCADraw.hpp
 * 
 * @brief CAData Convert mouse press points to pixels to be updated in cellState[][][]
*/
...
/**
 * @brief Convert mouse press points to pixels to be updated in cellState[][][]
 * 
*/
class CADraw{
private:
	...
	/**
	 * @brief pixels to be cloned to cellState
	*/
	struct drawnPixel{
	...
	*/
	...
	/**
	 * @brief pixel mouse mouse press points buffer
	*/
	struct drawBuffer{
	...
	/**
	 * @brief Check if pixel is already in buffer for this frame
	*/
...
public:
	...
	/**
	 * @brief Mouse draw on cellState values. called by InputHandler
	 * 
	 * @param strength drawn cell state
	 * @param cursorX
	 * @param cursorY
	 * @param drawRadius drawn circle radius
	 * @param drawRandom bool draw random pixels?
	 * @param cache main thread cache
	 * 
	*/
	...
	/**
	 * @brief Copy drawn pixels on this frame to cellState[][][]
	 * 
	 * @note CAData iteration threads must be paused before copyDrawBuf call
	*/
