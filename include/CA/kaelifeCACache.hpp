...
/**
 * @file kaelifeCACache.hpp
 * @brief CAData Thread cache and copy
*/
...
/**
 * @brief Unique thread cache of Cellular Autoamta variables
*/
class CACache {
public:
	CACache() {}
	...
	/**
	 * @brief Unique cache data struct
	*/
	struct ThreadCache{
	...
	/** 
	 * @brief Copy parent variables to thread cache 
	 * 
	 * @param dst destination cache
